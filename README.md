...
| [`testing/`](./testing) | Table-driven tests, t.Parallel, testing.TB helpers, benchmarks, interface-based test doubles |
| [`io/`](./io) | Custom io.Reader/Writer, decorator pattern, io.Pipe, bufio.Scanner with custom split |
| [`embedding/`](./embedding) | Struct embedding, method promotion, interface embedding, embedding vs. composition |
| [`pointers/`](./pointers) | Nil safety, value vs pointer receivers, aliasing, escape analysis, loop variable capture |
...
# Run the testing examples (uses go test, not go run)
go test -v ./testing/
